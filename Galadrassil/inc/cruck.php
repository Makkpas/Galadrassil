<div class="garden_body">
    <ul class="garden_pots">
            ...
            for($contador;$contador<11;$contador++){
              ...
              echo '<img onclick="mostrarPlanta(id,src)" data-id_arbol="'.$arbolID.'" data-abono="'.$arbolDetalles[0]['abono'].'" data-agua="'.$arbolDetalles[0]['agua'].'" data-tiempo_actual="'.time().'" data-tiempo_abono="'.$arbolDetalles[0]['tiempo_abono'].'" data-tiempo_agua="'.$arbolDetalles[0]['tiempo_agua'].'" data-name="'.$arbolInfo[0]['tipo'].'" id="'.$contador.'" class="garden_pots_item_svg" src="./assets/svg/t_'.$arbolInfo[0]['tipo'].'_'.$arbolInfo[0]['etapa'].'.png" alt="Maceta">';
              echo '</li>';
            }else{
